...
class ProgrammerAgent(Agent):
    def __init__(self):
        super().__init__("Programmer", "Разработчик", "Пишет код, создаёт функции, исправляет баги")
...
class TesterAgent(Agent):
    def __init__(self):
        super().__init__("Tester", "Тестировщик", "Пишет тесты, ищет баги, проверяет качество")
...
class TeamLeadAgent(Agent):
    def __init__(self):
        super().__init__("TeamLead", "Тимлид", "Координирует команду, проверяет архитектуру")
